...
const poems: Poem[] = [
    ...
    { id: 29, title: "Жизнеутверждающая Оптимистичная ПесенкА" },
    { id: 30, title: "Прикольная песенка банковского вкладчика." },
    { id: 31, title: "Смешная песенка про выборы." },
    { id: 32, title: "Прикольная песенка о ПФР." },
    { id: 33, title: "Жалостливая песенка Васильевой." },
    { id: 34, title: "Песенка Васильевой — 2" },
    { id: 35, title: "Песенка про Ходорковского." },
    { id: 36, title: "Песенка про Навального." },
    { id: 37, title: "Пусси Райот." },
    { id: 38, title: "Майдан." },
    { id: 39, title: "Гимн современной России." },
];
